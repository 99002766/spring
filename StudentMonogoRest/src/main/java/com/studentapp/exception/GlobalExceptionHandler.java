...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler{
	...
	protected ResponseEntity<Object> handleHttpMediaTypeNotSupported(HttpMediaTypeNotSupportedException ex,
        ...
        StudentAPIErrors apierrors=new StudentAPIErrors(message,timestamp,status,details);
	...
	@Override
	 protected ResponseEntity<Object> handleHttpRequestMethodNotSupported(HttpRequestMethodNotSupportedException ex,
	    ...
	    StudentAPIErrors apierrors=
	    		new StudentAPIErrors(message,timestamp,status,details);
	        return ResponseEntity.status(status).body(apierrors);
	    }
	...
	protected ResponseEntity<Object> handleTypeMismatch(TypeMismatchException ex, HttpHeaders headers,
	 ...
	 @ExceptionHandler(StudentNotFoundException.class)
	    ...
	    handleBookException(StudentNotFoundException ex){
	        ...
	        StudentAPIErrors apierrors=new StudentAPIErrors(message,timestamp,HttpStatus.BAD_REQUEST,details);
	    ...
	    handleOtherException(Exception ex){
	        ...
	        StudentAPIErrors apierrors=new StudentAPIErrors(message,timestamp,HttpStatus.INTERNAL_SERVER_ERROR,details);
